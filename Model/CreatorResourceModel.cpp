...
QString CreatorResourceModel::getResource(CreatorResourceModel::ResModelType modelType, CreatorResourceModel::ResItemType itemType)
{
    switch (modelType) {
    case MODEL_MENU:
        return resourceIcon.at(itemType);
    case MODEL_RAIL:
    case MODEL_STATION:
        return resourceItem.at(itemType);
    }
}
